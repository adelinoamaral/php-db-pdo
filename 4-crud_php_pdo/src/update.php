...
// for example update.php?id=1 will get the contact with the id of 1
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
    ...
    if (!$contact) {
        exit('O contacto com o ID indicado não existe!');
    }
} else {
...
<?=template_header('Atualizar Contacto')?>
<div class="content update">
	<h2>Atualizar Contacto #<?=$contact['id']?></h2>
